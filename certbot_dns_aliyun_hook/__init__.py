...
========================================  =====================================
``--dns-aliyun-credentials``              Aliyun credentials_ INI file.
                                          (Required)
...
Use of this plugin requires a configuration file containing Aliyun API
credentials, obtained from your Aliyun
`API page <https://help.aliyun.com/knowledge_detail/38738.html>`_.
...
.. code-block:: ini
   ...
   dns_aliyun_api_key = 1234567890abcdef1234567890abcdef
   dns_aliyun_secret_key = 1122334455667788
